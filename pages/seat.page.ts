...
export type TSeatPage = {
    ...
    seleccionar_asiento_tarifa_premium(numero_pasajeros: any): Promise<void>;
    seleccionar_asiento_tarifa_plus(numero_pasajeros: any): Promise<void>;
    seleccionar_asiento_tarifa_economy(numero_pasajeros: any): Promise<void>;
    seleccionar_asiento_tarifa_business(numero_pasajeros: any): Promise<void>;
    seleccionar_asiento_emergency(numero_pasajeros: any): Promise<void>;
    seleccionar_asientos(tarifaAsientos: any, numero_pasajeros: any): Promise<void>;
...
const SeatPage: TSeatPage = {
    ...
    async ir_a_pagar(): Promise<void> {
        ...
        try {
            ...
            await expect(page.getByRole('button', { name: copySeat.seat[lang].seatPagar, exact: true })).toBeVisible()
            await page.getByRole('button', { name: copySeat.seat[lang].seatPagar, exact: true }).click({ delay: helper.getRandomDelay() });
